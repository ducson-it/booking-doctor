...
<div class="container">
    <div class="row">
        <h1 class="text-center py-lg-5" style="font-size: 26px ;">Setup package</h1>
    </div>
    <form action="{{ route('package.bill') }}" id="form-package" method="get">
        @csrf
        <div class="row">
            <form action="" method="post">
                <div class="col-lg-4">
                    <div class="description">
                        <h3>Lựa chọn bác sĩ trong gói khám bệnh</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="row d-flex p-2">
                                ...
                                <div class="itemDoctor col-4">
                                    <label for="doctor-package{{ $key }}"><img width="100%" src="{{ asset('img/bookingcare-cover-4.jpg') }}" alt="">
